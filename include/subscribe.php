...
$apiKey = '7980538f5e5c760124d09b6c9a9fcbed-us13'; // Your MailChimp API Key
$listId = 'a578d1a552'; // Your MailChimp List ID
...
if( isset( $email ) AND $email != '' ) {
	...
	if ( isset( $data->status ) AND $data->status == 'subscribed' ){
		header("Location:  https://secure.peerplays.com/cart.php");
	} else {
		header("Location:  https://secure.peerplays.com/cart.php");
	}
